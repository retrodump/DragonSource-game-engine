...
Begin VB.Form frmChars 
   ...
   Caption         =   "DragonSource (Characters)"
   ClientHeight    =   4560
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8190
   ...
   Begin VB.ListBox lstChars 
      ...
      ForeColor       =   &H00FFC0C0&
      Height          =   1170
      ItemData        =   "frmChars.frx":5294
      Left            =   3120
      List            =   "frmChars.frx":5296
      TabIndex        =   2
      Top             =   1080
      Width           =   4575
   End
