...
Begin VB.Form frmTrade 
   ...
   Begin VB.ListBox lstTrade 
      ...
      ForeColor       =   &H00FFC0C0&
      Height          =   1920
      ItemData        =   "frmTrade.frx":29C8
      Left            =   3360
      List            =   "frmTrade.frx":29CA
      TabIndex        =   4
      Top             =   960
      Width           =   4575
   End
